...
<body>
    ...
    <div class="container">
        <form action="./server/rePassword.php" method="post" class=" bg-secondary justify-content-center pb-3">
            ...
            <div class="text-center mt-5">
                <button name="rePassword" class="btn btn-primary">เปลี่ยนรหัสผ่าน</button>
